...
@export var camera_rotation_component : BlurVelocityComponentResource = preload("res://addons/sphynx_motion_blur_toolkit/pre_blur_processing/resources/default_camera_rotation_component.tres")
@export var camera_movement_component : BlurVelocityComponentResource = preload("res://addons/sphynx_motion_blur_toolkit/pre_blur_processing/resources/default_camera_movement_component.tres")
@export var object_movement_component : BlurVelocityComponentResource = preload("res://addons/sphynx_motion_blur_toolkit/pre_blur_processing/resources/default_object_movement_component.tres")

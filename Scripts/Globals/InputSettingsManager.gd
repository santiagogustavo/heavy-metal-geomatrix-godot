...
var mouse_horizontal_sensitivity: float = 0.5
var mouse_vertical_sensitivity: float = 0.5

var stick_horizontal_sensitivity: float = 2.0
var stick_vertical_sensitivity: float = 2.0

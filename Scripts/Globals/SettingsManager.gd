...
func load_video_settings():
	...
	VideoSettingsManager.set_max_fps_enabled(file.get_value("video", "max_fps_enabled", VideoSettingsManager.max_fps_enabled))
...
func load_gameplay_settings():
	...
	GameplaySettingsManager.set_free_look_enabled(file.get_value("gameplay", "free_look_enabled", GameplaySettingsManager.free_look_enabled))
	GameplaySettingsManager.set_blood_amount(file.get_value("gameplay", "blood_amount", GameplaySettingsManager.blood_amount))
...
func save_video_settings():
	...
	file.set_value("video", "max_fps_enabled", VideoSettingsManager.max_fps_enabled)
...
func save_gameplay_settings():
	...
	file.set_value("gameplay", "free_look_enabled", GameplaySettingsManager.free_look_enabled)
	file.set_value("gameplay", "blood_amount", GameplaySettingsManager.blood_amount)
